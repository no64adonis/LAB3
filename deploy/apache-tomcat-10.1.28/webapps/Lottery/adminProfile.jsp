...
<head>
    ...
    <title>Admin Profile - Lottery</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/adminLottery.css?v=<%= System.currentTimeMillis() %>">
                    ...
                    <div class="profile-container">
                        ...
                        <div class="profile-section">
                            ...
                            <form action="adminProfile" method="post">
                                ...
                                <button type="submit" class="btn lottery-btn">Update Name</button>
                            </form>
                        </div>
                        ...
                        <div class="profile-section">
                            ...
                            <form action="adminProfile" method="post">
                                ...
                                <button type="submit" class="btn lottery-btn">Send Verification Code</button>
                            </form>
                            ...
                            <div class="verification-section">
                                ...
                                <form action="adminProfile" method="post">
                                    ...
                                    <button type="submit" class="btn lottery-btn">Verify & Update Email</button>
                                </form>
                            </div>
                            <% } %>
                        </div>
